...
return [
    ...
    */
    ...
    |
    */
    'secret_key' => env('RECAPTCHA_V3_SECRET_KEY', '6Leja7EaAAAAAAuaQJxK1Wu_2qeFP0wmgjWHdLh3'),
    /*
    |--------------------------------------------------------------------------
    | Site Key
    |--------------------------------------------------------------------------
    ...
    |
    */
    'site_key' => env('RECAPTCHA_V3_SITE_KEY', '6Leja7EaAAAAAEneQM_7JDANNrTTlal_Y0Fjxler'),
