        ...
        <div id="kt_content_container" class="container">
            <div class="card">
                ...
                <div class="card-body pt-0">
                    <form class="form" method="POST" action="{{route('admin.blogs.store')}}" id="kt_modal_add_customer_form" enctype="multipart/form-data">
                        @csrf

                        <div class="scroll-y me-n7 pe-7">
                            <div class="fv-row mb-7">
                                <label class="required fs-6 fw-bold mb-2">Title</label>
                                <input type="text" class="form-control form-control-solid" value="{{ old('title') }}" name="title" />
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <input type="text" class="form-control form-control-solid" value="{{ old('slug') }}" name="slug" />
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <textarea class="form-control form-control-solid" name="content" id="editor" rows="10" cols="80">{!! old('content') !!}</textarea>
